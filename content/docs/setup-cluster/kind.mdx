...
<Tabs items={["Mac (with brew)","Mac (without brew)","Linux","Windows (with Chocolatey)","Windows"]}>

<Tab value="Mac (with brew)">
...
<Tab value="Windows (with Chocolatey)">
