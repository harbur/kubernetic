...
ConfigMaps do not provide secrecy or encryption. If the data you want to store are confidential, use a [Secret](/tutorials/configuration/secrets) rather than a ConfigMap.
